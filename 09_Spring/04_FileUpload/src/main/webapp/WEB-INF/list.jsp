...
<body>
	<div class="container">
		<h1>List Page</h1>
		<form action="/list">
			검색 : <input type="text" name="keyword" placeholder="${param.keyword}"/>
		...
		<nav>
			<ul class="pagination">
				<li class="page-item ${paging.prev ? '' : 'disabled'}"><a class="page-link" href="/list?keyword=${param.keyword}&page=${paging.startPage - 1}">Previous</a></li>
							
					<c:forEach begin="${paging.startPage}" end="${paging.endPage}" var="page">
						<li class="page-item"><a class="page-link ${paging.page == page ? 'active' : ''}" href="/list?keyword=${param.keyword}&page=${page}">${page}</a></li>
					</c:forEach>
							
				<li class="page-item ${paging.next ? '' : 'disabled'}"><a class="page-link" href="/list?keyword=${param.keyword}&page=${paging.endPage + 1}">Next</a></li>
			</ul>
		</nav>
