...
public class DispatcherServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//System.out.println("RequestURI : " + requestURI); // /register.do
		String[] requestURIList = requestURI.split("/");
		//System.out.println(Arrays.toString(requestURIList)); // [, register.do]
		String command = requestURIList[requestURIList.length - 1];
		//System.out.println("command : " + command); // register.do
