...
DROP TABLE HRM_WORK;
DROP TABLE FINANCIAL_SALARY;
DROP TABLE FINANCIAL_TRANSACTION;
DROP TABLE FINANCIAL_BUDGET;
...
CREATE TABLE DEPARTMENT(
 ...
 DEPT_NAME VARCHAR(100) NOT NULL, -- ex) 개발팀
 DEPT_COLOR VARCHAR(50)
);

CREATE TABLE GRADE(
 GRADE_NO INT PRIMARY KEY AUTO_INCREMENT,
 GRADE_NAME VARCHAR(100) NOT NULL -- ex) 사원
 );
...
CREATE TABLE SCHEDULE(
 ...
 SCHEDURE_TITLE VARCHAR(100) NOT NULL,
 SCHEDURE_DESC TEXT,
 START_DATE DATE,
 END_DATE DATE,
 STATUS VARCHAR(30) CHECK (STATUS IN ('진행 전', '진행 중', '완료', '중단')),
...
-- 가장 해볼만 하다 싶은거 1개만 하셔도 괜찮고~ 아이디어 있으면 여러개 해도 무방!
/*
-- 재무관리
CREATE TABLE FINANCIAL_MANAGEMENT(
 EXPENSES_NO INT AUTO_INCREMENT PRIMARY KEY,
 BUDGETS VARCHAR(100),
 EXPENSES_DETAILS VARCHAR(100),
 EXPEND_DATE DATE,
 COST INT,
 PRO_NO INT,
 TASK_NO INT
...
CREATE TABLE HRM_LEAVES(
 LEAVE_NNO INT AUTO_INCREMENT PRIMARY KEY,
 START_DATE DATE,
 END_DATE DATE,
 REASON TEXT,
...
CREATE TABLE FINANCIAL_BUDGET(
 ...
 ANNUAL_BUDGET INT, -- 매년 목표 예산
 ANNUAL_PLAN TEXT, -- 각 부서 별 예산소진 계획
...
CREATE TABLE QUALITY(
 ...
 STATUS VARCHAR(20) CHECK (STATUS IN ('정상', '불량', '조치 필요')),
 USER_NO INT
);
