...
INSERT INTO MEM_PRI(MEM_NO, MEM_ID, MEM_PWD, MEM_NAME, GENDER, MEM_DATE, EMAIL) VALUES(1, 'user03', 'pass03', '곽병현', '남', SYSDATE, 'bbb@google.com');
SELECT * FROM MEM_PRI;
...
/*
   ...
   * 삭제옵션 : 부모테이블의 데이터 삭제 시 그 데이터를 사용하고 있는 자식테이블의 값을 어떻게 처리할건지
   ...
   - ON DELETE RESRTICTED(기본값) : 자식데이터로 쓰이는 부모데이터는 삭제 아예 안되게끔
...
INSERT INTO PUBLISHER(PUB_NAME, PHONE) VALUES('출판사1', '070-1111-2222');
INSERT INTO PUBLISHER(PUB_NAME, PHONE) VALUES('출판사2', '02-1234-5678');
SELECT * FROM PUBLISHER;

-- 테이블명 : BOOK
-- 컬럼 : BK_NO - 숫자, 기본키
--       BK_TITLE - 문자(50), NULL 허용 X
--       BK_AUTHOR - 문자(50), NULL 허용 X
...
INSERT INTO BOOK(BK_TITLE, BK_AUTHOR, PUB_NO) VALUES('책제목1', '저자1', 1);
INSERT INTO BOOK(BK_TITLE, BK_AUTHOR, PUB_NO) VALUES('책제목2', '저자2', 2);
INSERT INTO BOOK(BK_TITLE, BK_AUTHOR, PUB_NO) VALUES('책제목3', '저자3', 2);

SELECT * FROM BOOK;
SELECT * FROM PUBLISHER;

-- DELETE FROM PUBLISHER WHERE PUB_NO = 1;
...
--       BK_NO - 숫자, 외래키 (BOOK의 BK_NO, 삭제조건 SET NULL)
CREATE TABLE RENT(
...
-- 변경하려는 자료형의 데이터가 존재할 바꾸려고 해서 에러!
...
*/
ALTER TABLE DEPT_COPY
RENAME CONSTRAINT SYS_C008412 TO DEPT_ID_PK;
